...
export const getWeekdaysMin = (locale, firstDayOfWeek) => {
  dayjs().locale(locale);
...
export const getDate = date => dayjs(date, DATE_FORMAT);
...
export function getDaysInMonth(date, displayFullDays, firstDayOfWeek) {
 ...
 */
export const getMonthDays = (datetime = dayjs(), displayFullDays, minDate, maxDate, firstDayOfWeek, disabledDates) => {
...
export function addColorAlpha(color, opacity) {
