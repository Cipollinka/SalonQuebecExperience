...
[![Release Version](https://img.shields.io/badge/release-1.3.13-brightgreen.svg)](https://github.com/Tencent/MMKV/releases)
...
```gradle
dependencies {
    implementation 'com.tencent:mmkv:1.3.13'
    // replace "1.3.13" with any available version
}
```
